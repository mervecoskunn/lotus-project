...
def add_products():
    Product.objects.create(name='Chakra Bracelet', price=15, category=cat_bracelet,
    ...
    Product.objects.create(name='Amethyst Natural Stone Bracelet', price=10, category=cat_bracelet,
                    ...
                    ⦁	Protection: Amethyst is considered a protective stone that wards off negative energies and psychic attacks, creating a shield of spiritual light around the body""", rating=4.8),

    Product.objects.create(name='Rose Quartz Natural Stone Bracelet',
        ...
        ⦁	Harmony and Balance: Rose quartz promotes harmony and balance in relationships, enhancing communication, understanding, and mutual respect""", rating=5, ),

    Product.objects.create(name='LAPIS CHAKRA STONE', price=10, category=cat_chackra_stone, description="""Lapis Lazuli for Throat Chakra: Enhance Communication and Self-Expression
        ...
        Enhance communication, support self-expression, and promote truth and integrity by incorporating the powerful energy of Lapis Lazuli into your Throat Chakra balancing practices.""", rating=4.5),

    Product.objects.create(name='CROWN CHAKRA STONE - LABRADORITE', price=10,
        ...
        Connect to higher consciousness, enhance spiritual growth, and tap into intuitive wisdom by incorporating the transformative energy of Labradorite into your Crown Chakra balancing and spiritual practices.""", rating=5),

    Product.objects.create(name='CROWN CHAKRA STONE - AMETHYST', price=10,
    ...
    Product.objects.create(name='CHAKRA INCENCE', price=15, category=cat_incense, description="""Chakra Incense: Harmonize Your Energy Centers
        ...
        Elevate your spiritual journey, align your energy centers, and infuse your space with harmony and balance by incorporating Chakra Incense into your daily rituals and practices""", rating=1.5),

    Product.objects.create(name='SANTA PALO INCENCE', price=12, category=cat_incense,
        ...
        Elevate your spiritual practices, purify your space, and promote overall well-being by incorporating the sacred and purifying aroma of Santa Palo Incense into your daily rituals and practices""", rating=3.5),

    Product.objects.create(name='JASMINE INCENCE', price=14, category=cat_incense,
        ...
        Elevate your senses, promote relaxation, and infuse your space with the enchanting and uplifting aroma of Jasmine Incense by incorporating this beautiful incense into your daily rituals and practices.""", rating=3.6),

    Product.objects.create(name='AMETHYST NATURAL STONE', price=50, category=cat_natural_stone,
        ...
        Elevate your living or workspace, enhance your well-being, and tap into the calming and balancing energy of Amethyst by incorporating this beautiful natural stone into your environment""", rating=5),

    Product.objects.create(name='CITRINE NATURAL STONE', price=55, category=cat_natural_stone,
        ...
        Elevate your living or workspace, attract prosperity, and infuse your environment with the uplifting and energizing energy of Citrine by incorporating this beautiful natural stone into your space""", rating=2.8),

    Product.objects.create(name='TURQUOISE NATURAL STONE ', price=35, category=cat_natural_stone,
        ...
        Elevate your living or workspace, promote calmness and protection, and infuse your environment with the soothing and protective energy of Turquoise by incorporating this beautiful natural stone into your space.""", rating=5),

    Product.objects.create(name='Crystal Quartz Pendulum', price=20, category=cat_pendulum,
        ...
        ⦁	Amplifies Energy: Crystal quartz acts as an energy amplifier, enhancing the effects of other stones and balancing your energy centers for improved vitality and well-being.""", rating=4.7),

    Product.objects.create(name='Pink Quartz Pendulum', price=20, category=cat_pendulum,
        ...
        ⦁	Emotional Healing: Pink quartz supports emotional healing, reducing stress, anxiety, and emotional turmoil, and promoting inner peace, serenity, and overall emotional well-being.""", rating=4.2),

    Product.objects.create(name='Brass Pendulum', price=20, category=cat_pendulum,
        ...
        ⦁	Versatile and Easy to Use: Our brass pendulum is versatile and easy to use, making it suitable for both beginners and experienced practitioners alike.""", rating=5),
